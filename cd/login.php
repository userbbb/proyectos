...
<li><input type="password" required class="input" placeholder="Contraseña" name="password"/><span class="icon"><i class="fa fa-lock"></i></span></li>
<li><span class="remember"><input type="checkbox" id="check"> <label for="check">Recordarme</label></span><span class="remember"><a href="">¿Has olvidado tu contraseña?</a></span></li>
