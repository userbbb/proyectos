...
if(isset($_POST['enviar']))
{
	if(
		...
		if (!confirm("Te hacen falta registrar campos obligatorios por favor verifica y vuelve a intentarlo"))
		{
		history.back();
		}
		</script>
	...
	<body>
        ...
        Selecciona un color3: <input name="color3" type="color" value="#f3f3f3"/>
			<section id="header">
				<div class="inner">
					...
					<h1><input name="titulo" rows="10" cols="50" value="Titulo"></input></h1>
					<ul class="actions">
				...
				<div class="container">
					<div class="row 150%">
						<div class="6u 12u$(medium)">
							...
							<textarea name="introduccion" rows="6" cols="50" ></textarea>
						</div>
						<div class="6u$ 12u$(medium) important(medium)">
							<!--<span class="image fit"><img src="images/pic01.jpg" alt="" /></span> -->
                            <textarea name="contenido1" rows="10" cols="50" >contenido</textarea>
						</div>
					</div>
				</div>
			</section>
		...
		<!-- Two -->
			<section id="two" class="main style2">
				<div class="container">
					<div class="row 150%">
						<div class="6u 12u$(medium)">
							<textarea name="contenido2" rows="10" cols="50" ></textarea>
						</div>
						<div class="6u$ 12u$(medium)">
							<textarea name="contenido3" rows="10" cols="50" ></textarea>								
						</div>
					</div>
				</div>
			</section>
		...
		<!-- Three -->
			<section id="three" class="main style1 special">
				<div class="container">
					<header class="major">
						<h2><input name="titulo2" rows="10" cols="50" ></input></h2>
					</header>
					<p> <textarea name="introduccion2" rows="10" cols="50" ></textarea>
                    <input type="file" required="required" size="10" name="arc"></p>
					<div class="row 150%">
